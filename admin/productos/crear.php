        ...
        <div class="container card mt-5">
            <form action="procesar_formulario.php" method="POST" enctype="multipart/form-data" class="p-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control mb-3" id="nombre" name="nombre" required>
                </div>

                <div class="form-group">
                    <label for="descripcion">Descripción del producto:</label>
                    <textarea class="form-control mb-3" id="descripcion" name="descripcion" required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control mb-3" id="precio" name="precio" pattern="[0-9]+(\.[0-9]{1,2})?" oninput="this.value = this.value.replace(/-/g, '')" step="0.01" required>
                </div>
                ...
                <a name="" id="" class="btn btn-primary" href="http://localhost/dashboard/inte/admin/index.php" role="button">Cancelar</a>
            </form>
