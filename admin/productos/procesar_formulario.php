...
<body>
    ...
    <main class="contenido mt-5">
        ...
        // Recibe la imagen del formulario
        $imagen = addslashes(file_get_contents($_FILES['imagen']['tmp_name']));

        // Inserta los datos en la tabla "productos_local"
        $query = "INSERT INTO menu (nombre, descripcion, precio, imagen, local_id) VALUES ('$nombre_producto', '$descripcion_producto', '$precio', '$imagen', '$id_local')";
        ...
        if ($resultado) {
            ...
            echo '<div class="alert alert-success w-50 mx-auto">' . "Producto insertado correctamente" . '</div>';
            echo '<img src="../../images/giphy.gif" class="text-center justify-content-center" alt="" width="150px">';
            echo '<a name="" id="" class="btn btn-primary mt-3" href="http://localhost/dashboard/inte/admin/index.php" role="button">VOLVER</a>';
            echo '</div>';
        } else {
